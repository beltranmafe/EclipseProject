 ...
 */
@ProviderType
public class EscritorWrapper
	extends BaseModelWrapper<Escritor>
	implements Escritor, ModelWrapper<Escritor> {
	...
	public void setEscritorId(long escritorId) {
		model.setEscritorId(escritorId);
	}
	...
	@Override
	protected EscritorWrapper wrap(Escritor escritor) {
		return new EscritorWrapper(escritor);
	}
